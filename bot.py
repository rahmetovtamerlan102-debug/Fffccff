...
async def start(msg: Message):
    await msg.answer("👋 Отправь @username или ID. Бот — точная копия твоего скрипта.")
...
# ===== ЗАПУСК =====
async def main():
    print("🚀 Бот запущен (как твой скрипт)")
